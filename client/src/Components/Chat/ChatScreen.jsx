    ...
    <div className="flex-1 h-full justify-between flex flex-col gap-3">
      <div className="flex w-full items-center py-2 px-3 border-b-2 border-base-300 justify-between">
        <div className="flex items-center gap-3">
          <div
            className={`avatar ${Array.isArray(onlineUsers) && onlineUsers.includes(selectedUser._id) ? "avatar-online" : "avatar-offline"}`}
          >
            ...
            <p className="text-xs text-gray-500">
              ...
              onlineUsers.includes(selectedUser._id)
                ...
                : selectedUser.lastSeen &&
                    !isNaN(new Date(selectedUser.lastSeen))
                  ? "Last seen, Today at  " +
      ...
      <div
        className="flex-1 w-full overflow-y-auto flex flex-col gap-2 py-1 px-3"
        id="chat-scroll"
      >
        <Timestamp />
        {messages.length > 0 &&
      ...
      <div className="flex w-full items-center py-1 ps-1 pe-3 gap-1 border-t-2 border-base-300">
        ...
        {input.trim() === "" ? (
          ...
          <div
            ...
            className="h-[2.5em] w-[2.5em] rounded-sm hover:bg-base-300 flex items-center justify-center"
          >
